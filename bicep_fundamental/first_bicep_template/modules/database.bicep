...
var sqlServerName = 'sol2${location}${uniqueString(resourceGroup().id)}'
var sqlDatabaseName = 'TeddyBearsol2'
var auditingEnabled = environmentName == 'Production'
var auditStorageAccountName = take('sol2${location}${uniqueString(resourceGroup().id)}', 24)
